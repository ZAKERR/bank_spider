...
def get_oname(txt):
    ...
    if txt:
        ...
        first = re.search(r'(个人姓名：|单位名称：|当事人:|当事人：|被处罚个人名称：|处罚人：|受处罚机构：|受罚人（机构）：|受处罚机构名称：|受处罚人名称：|受处罚人姓名：)(.*?)(Microsoft|银监会|身份证|营业|地址|住址|住所|年龄|职务|主要负责人|\d+岁|，)', txt)
        second = re.search(r'(个人姓名：|单位名称：|当事人:|当事人：|被处罚个人名称：|处罚人：|受处罚机构：|受罚人（机构）：|受处罚机构名称：|受处罚人名称：|受处罚人姓名：)(.*?公司.*?(支|分)公司)(年龄|Microsoft|银监会|身份证|营业|地址|住址|住所|职务|主要负责人)', txt)
...
def get_cf_jg(txt):
    """ 获取处罚结果 """
    if txt:
        first = re.search(r'(作出如下处罚：|决定给予你单位以下行政处罚：|条规定，|作出如下行政处罚：)(.*?)(当事人如对本处罚决定不服|如你公司|请在接到本处罚决定书|当事人如不服|你应自收到本处罚|你单位应自收到)', txt)
        second = re.search(r'((现责令|决定给予|我局决定|对你公司|我分局决定).*?。)', txt)
        if first:
            cf_jg = first.group(2)
        elif second:
